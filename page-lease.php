...
<section class="l-leaseFeatures ">
  <div class="l-cs_pc l-cs_sp">

    <div class="c-leaseTtl">
      <p class="c-leaseTtl__en u-txt_xl u-bold u-ta_c">FEATURES</p>
      <h2 class="c-leaseTtl__jp u-txt_l3 u-bold u-ta_c">Bleong One リースプランの特長</h2>
    </div>

    <ul class="l-leaseFeatures__list p-listFeature">
...
<section class="l-leaseLineup u-bg-blue">
  <div class="l-cs_pc l-cs_sp">

    <div class="c-leaseTtl">
      <p class="c-leaseTtl__en u-txt_xl u-bold u-ta_c">LINE UP</p>
      <h2 class="c-leaseTtl__jp u-txt_l3 u-bold u-ta_c">ラインナップ</h2>
    </div>

    <div class="l-leaseLineup__list p-leasePlan">
          ...
          <ul class="p-rental__list">
            <li class="c-rentalItem">
              ...
              <div class="c-rentalItem__doc">
                ...
                <p class="c-rentalItem__docName u-txt_m5 u-bold">
                  iPhone 7
                </p>
